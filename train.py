...
from utils.loss_utils import l1_loss, TV_loss, boundary_aware_contrastive_loss, color_aware_dice_loss, \
    region_smooth_loss
...
if __name__ == "__main__":
    ...
    lp = lp.extract(args)
    # if args.vlm == 'surgvlp':
    #     lp._language_features_name = "language_features_surg_dim3_new"
